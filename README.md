...
## Setup Render Enviroment

###  Setup DB

- Create new DB Postgres:

|Name|Value|
|---|---|
|Name DB on render|examdb|
|Name Connect DB|examdb_uyig|
|UserAdmin|adm|
|Password|UvZK7@UQhUbtZXccphztAIQjrenDNn71o|
|Region|Singapore|
|Version|15|
|Domain internal|dpg-clo7u6uqc21c73e48vl0-a|
|Domain External|dpg-clo7u6uqc21c73e48vl0-a.singapore-postgres.render.com|
|Connect String Internal|postgres://adm:UvZK7@UQhUbtZXccphztAIQjrenDNn71o@dpg-clo7u6uqc21c73e48vl0-a/examdb_uyig|
|Connect String External|postgres://adm:UvZK7@UQhUbtZXccphztAIQjrenDNn71o@dpg-clo7u6uqc21c73e48vl0-a.singapore-postgres.render.com/examdb_uyig|
|PSQL Command|PGPASSWORD=UvZK7@UQhUbtZXccphztAIQjrenDNn71o psql -h dpg-clo7u6uqc21c73e48vl0-a.singapore-postgres.render.com -U adm examdb_uyig|

Note: Please change a Character for get Password.
- Access to manage Render DB:
> https://dashboard.render.com/d/dpg-clo7u6uqc21c73e48vl0-a

### Setup New service Web

- **Name:** render-udacity-exam
- **DB_STRING_CONNECTION_INTERNAL**: postgres://adm:UvZK7@UQhUbtZXccphztAIQjrenDNn71o@dpg-clo7u6uqc21c73e48vl0-a/examdb_uyig
- **Health Check Path:** /healthy
- **Web link**: https://render-udacity-exam.onrender.com
...
![permission_barista](images//permission_barista.png)

Manager: Full Access
![permission_manager](images//permission_manager.png)
...
![test_barista](images//test_barista.png)
...
## Deployment
![render_services](images//render_services.png)
...
![request_manager](images//request_manager.png)
...
![request_barista](images//request_barista.png)
